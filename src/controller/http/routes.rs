...
use super::handlers::{
    ...
    open_shell_handler, close_shell_handler,
...
pub fn build_router(state: AppState) -> Router {
    ...
    let read_routes = Router::new()
        ...
        .route("/sessions/orphaned", get(list_orphaned_handler))
    ...
    let write_routes = Router::new()
        ...
        .route("/sessions/:id/shell", post(open_shell_handler))
        .route("/sessions/:id/shell", delete(close_shell_handler))
